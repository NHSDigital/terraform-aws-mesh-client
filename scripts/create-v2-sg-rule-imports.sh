...
terraform import 'module.mesh.aws_security_group_rule.check_send_ssm' '${sg_check_send_id}_egress_tcp_443_443_${ssm_sg_id}'
terraform import 'module.mesh.aws_security_group_rule.fetch_message_ssm' '${sg_fetch_chunk_id}_egress_tcp_443_443_${ssm_sg_id}'
terraform import 'module.mesh.aws_security_group_rule.poll_mailbox_ssm' '${sg_poll_mailbox_id}_egress_tcp_443_443_${ssm_sg_id}'
terraform import 'module.mesh.aws_security_group_rule.send_message_ssm' '${sg_send_chunk_id}_egress_tcp_443_443_${ssm_sg_id}'

terraform import 'module.mesh.aws_security_group_rule.check_send_sfn' '${sg_check_send_id}_egress_tcp_443_443_${sfn_sg_id}'
terraform import 'module.mesh.aws_security_group_rule.fetch_message_sfn' '${sg_fetch_chunk_id}_egress_tcp_443_443_${sfn_sg_id}'
terraform import 'module.mesh.aws_security_group_rule.poll_mailbox_sfn' '${sg_poll_mailbox_id}_egress_tcp_443_443_${sfn_sg_id}'
terraform import 'module.mesh.aws_security_group_rule.send_message_sfn' '${sg_send_chunk_id}_egress_tcp_443_443_${sfn_sg_id}'

terraform import 'module.mesh.aws_security_group_rule.check_send_logs' '${sg_check_send_id}_egress_tcp_443_443_${logs_sg_id}'
terraform import 'module.mesh.aws_security_group_rule.fetch_message_logs' '${sg_fetch_chunk_id}_egress_tcp_443_443_${logs_sg_id}'
terraform import 'module.mesh.aws_security_group_rule.poll_mailbox_logs' '${sg_poll_mailbox_id}_egress_tcp_443_443_${logs_sg_id}'
terraform import 'module.mesh.aws_security_group_rule.send_message_logs' '${sg_send_chunk_id}_egress_tcp_443_443_${logs_sg_id}'

terraform import 'module.mesh.aws_security_group_rule.check_send_kms' '${sg_check_send_id}_egress_tcp_443_443_${kms_sg_id}'
terraform import 'module.mesh.aws_security_group_rule.fetch_message_kms' '${sg_fetch_chunk_id}_egress_tcp_443_443_${kms_sg_id}'
terraform import 'module.mesh.aws_security_group_rule.poll_mailbox_kms' '${sg_poll_mailbox_id}_egress_tcp_443_443_${kms_sg_id}'
terraform import 'module.mesh.aws_security_group_rule.send_message_kms' '${sg_send_chunk_id}_egress_tcp_443_443_${kms_sg_id}'

terraform import 'module.mesh.aws_security_group_rule.check_send_lambda' '${sg_check_send_id}_egress_tcp_443_443_${lambda_sg_id}'
terraform import 'module.mesh.aws_security_group_rule.fetch_message_lambda' '${sg_fetch_chunk_id}_egress_tcp_443_443_${lambda_sg_id}'
terraform import 'module.mesh.aws_security_group_rule.poll_mailbox_lambda' '${sg_poll_mailbox_id}_egress_tcp_443_443_${lambda_sg_id}'
terraform import 'module.mesh.aws_security_group_rule.send_message_lambda' '${sg_send_chunk_id}_egress_tcp_443_443_${lambda_sg_id}'

terraform import 'module.mesh.aws_security_group_rule.check_send_secrets' '${sg_check_send_id}_egress_tcp_443_443_${secrets_sg_id}'
terraform import 'module.mesh.aws_security_group_rule.fetch_message_secrets' '${sg_fetch_chunk_id}_egress_tcp_443_443_${secrets_sg_id}'
terraform import 'module.mesh.aws_security_group_rule.poll_mailbox_secrets' '${sg_poll_mailbox_id}_egress_tcp_443_443_${secrets_sg_id}'
terraform import 'module.mesh.aws_security_group_rule.send_message_secrets' '${sg_send_chunk_id}_egress_tcp_443_443_${secrets_sg_id}'
