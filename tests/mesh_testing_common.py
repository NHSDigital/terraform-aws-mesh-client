...
class MeshTestingCommon:
    ...
    TEST_MAILBOX_ID1 = "X26ABC1"
    TEST_MAILBOX_ID2 = "X26ABC2"
    ...
    def setup_mock_aws_ssm_parameter_store(environment, ssm_client):
        ...
        ssm_client.put_parameter(
            ...
            + f"{environment}-mesh/X26ABC2/outbound/src_mailbox",
            Value="X26ABC2",
        )
        ssm_client.put_parameter(
            Name=f"/{environment}/mesh/mapping/"
            + f"{environment}-mesh/X26ABC2/outbound/dest_mailbox",
            Value="X26ABC1",
        )
        ssm_client.put_parameter(
            Name=f"/{environment}/mesh/mapping/"
            + f"{environment}-mesh/X26ABC2/outbound/workflow_id",
            Value="TESTWORKFLOW",
        )
        # Setup secrets
        ssm_client.put_parameter(
