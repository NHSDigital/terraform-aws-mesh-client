...
class TestMeshFetchMessageChunkApplication(MeshTestCase):
    ...
    def test_mesh_fetch_file_chunk_app_no_chunks_happy_path(self, mock_create_new_internal_id, response_mocker):
        ...
        self.assertEqual(mock_input["body"].get("internal_id"), response["body"].get("internal_id"))
        self.assertEqual(
        ...
        self.assertTrue(self.log_helper.was_value_logged("MESHFETCH0001", "Log_Level", "INFO"))
        self.assertTrue(self.log_helper.was_value_logged("MESHFETCH0001c", "Log_Level", "INFO"))
        self.assertTrue(self.log_helper.was_value_logged("MESHFETCH0002a", "Log_Level", "INFO"))
        self.assertFalse(self.log_helper.was_value_logged("MESHFETCH0003", "Log_Level", "INFO"))
        self.assertTrue(self.log_helper.was_value_logged("MESHFETCH0011", "Log_Level", "INFO"))
        # self.assertTrue(
        ...
        # )
        self.assertFalse(self.log_helper.was_value_logged("MESHFETCH0010a", "Log_Level", "INFO"))
    ...
    def test_mesh_fetch_file_chunk_app_2_chunks(
        ...
        mock_response.get(
            "/messageexchange/MESH-TEST1/inbox/" + f"{MeshTestingCommon.KNOWN_MESSAGE_ID1}/2",
            text=data2,
            status_code=HTTPStatus.OK.value,
            headers={
                "Content-Type": "application/octet-stream",
        ...
        self.assertTrue(self.log_helper.was_value_logged("MESHFETCH0001", "Log_Level", "INFO"))
        self.assertTrue(self.log_helper.was_value_logged("MESHFETCH0001c", "Log_Level", "INFO"))
        self.assertTrue(self.log_helper.was_value_logged("MESHFETCH0002", "Log_Level", "INFO"))
        self.assertTrue(self.log_helper.was_value_logged("MESHFETCH0003", "Log_Level", "INFO"))
        self.assertTrue(self.log_helper.was_value_logged("MESHFETCH0004", "Log_Level", "INFO"))
        # self.assertTrue(
        #     self.log_helper.was_value_logged("MESHFETCH0005a", "Log_Level", "INFO")
        # )
        # self.assertFalse(
    ...
    @mock.patch.object(MeshFetchMessageChunkApplication, "_create_new_internal_id")
    @requests_mock.Mocker()
    def test_mesh_fetch_file_chunk_app_2_chunks_using_temp_file(self, mock_create_new_internal_id, mock_response):
        """
        ...
        self.assertTrue(self.log_helper.was_value_logged("MESHFETCH0003", "Log_Level", "INFO"))
        self.assertTrue(self.log_helper.was_value_logged("MESHFETCH0004", "Log_Level", "INFO"))
        self.assertTrue(self.log_helper.was_value_logged("MESHFETCH0005a", "Log_Level", "INFO"))
        self.assertFalse(self.log_helper.was_value_logged("MESHFETCH0010a", "Log_Level", "INFO"))
        self.assertTrue(self.log_helper.was_value_logged("LAMBDA0003", "Log_Level", "INFO"))
    ...
    @mock.patch.object(MeshFetchMessageChunkApplication, "_create_new_internal_id")
    @requests_mock.Mocker()
    def test_mesh_fetch_file_chunk_app_report(self, mock_create_new_internal_id, response_mocker):
        ...
        self.assertTrue(self.log_helper.was_value_logged("MESHFETCH0012", "Log_Level", "INFO"))

    @mock_ssm
    @mock_s3
    @mock.patch.object(MeshFetchMessageChunkApplication, "_create_new_internal_id")
    @requests_mock.Mocker()
    def test_mesh_fetch_file_chunk_app_gone_away_unhappy_path(self, mock_create_new_internal_id, mock_response):
